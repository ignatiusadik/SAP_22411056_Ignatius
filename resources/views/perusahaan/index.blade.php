...
<div class="container">
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h4 class="card-title m-0">Data Perusahaan</h4>
      <a href="{{ route('superadmin.perusahaan.create') }}" class="btn btn-primary">Tambah Perusahaan</a>
    </div>
    <div class="card-body">
            ...
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item" href="{{ route('superadmin.perusahaan.edit', $item->id) }}">Edit</a>
                  </li>
                  <li>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Anda yakin ingin menghapus <strong>{{ $item->nama_perusahaan }}</strong>?<br>
        Data ini akan dihapus secara permanen.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
        <form action="{{ route('superadmin.perusahaan.destroy', $item->id) }}" method="POST">
          @csrf
          @method('DELETE')
